...
function ChatLLM({ children, variant = 'primary', isVisible, onClose }) {
  return (
    <div className={`container ${(isVisible ? "block" : "hidden")} sm:flex sm:flex-col`}>

      {/*Chatbot Header*/}
      <div className='flex p-15-25 items-center justify-between text-white  bg-blue-500'>
        <button className={' w-10 h-10 bg-blue-500 hover:bg-blue-800 text-white m-2 rounded flex items-center justify-center'} onClick={onClose}>
          <MdOutlineKeyboardDoubleArrowLeft />
        </button>
        <h2 className="font-bold text-white text-2xl">Asistente Larva</h2>
        <div className="chat-header w-10 h-10 m-2">
          <LuBot className='bg-blue-600 w-10 h-10 p-1 rounded-full' />
        </div>
      </div>
      ...
      <div className="h- overflow-y-auto">
        <div className="message bot-message">
          ...
          <p className="message-text">
            Como estas? <br /> espero que muy bien.
          </p>
        </div>
      ...
      {/*Chatbot footer*/}
      <div className="overflow-y-auto h-915px">
        <form action="#" className="flex flex-row justify-between">
          <input type="text" placeholder="Pregunta..." className=" bottom p-5 message-input w-full bg-red-100 " required />
          <button className={'w-10 m-5 bg-blue-500 text-white rounded flex items-center justify-center gap-20'} onClick={onClose}>
            <MdOutlineKeyboardDoubleArrowLeft />
          </button>
        </form>
      </div>
